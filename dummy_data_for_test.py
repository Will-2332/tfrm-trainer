...
def generate_and_save_calendar_data(csv_filename='enhanced_realistic_calendar_data.csv', num_samples=1000):
    ...
    leisure_activities = ['Reading', 'Watching TV', 'Playing Games', 'Exercising', 'Sleeping', 'Napping', 'Music', 'Date', 'Going Out with Friends', 'Party at Clubs','Cienama','Theatre','Museum Visit','Hiking']
    ...
    for _ in range(num_samples):
        ...
        if title in leisure_activities:
...
# To call the function and generate the data
if __name__ == "__main__":
    generate_and_save_calendar_data()
